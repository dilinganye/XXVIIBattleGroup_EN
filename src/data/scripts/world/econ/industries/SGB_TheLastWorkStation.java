...
public class SGB_TheLastWorkStation extends BaseIndustry implements FleetEventListener {
	...
	public static float SGB_ORBITAL_WORKS_QUALITY_BONUS = 0.25f;
	...
	public void apply() {
		...
		if(isFunctional()){
			qualityBonus = SGB_ORBITAL_WORKS_QUALITY_BONUS;
		}
...
//		}
	...
	protected void upgradeFinished(Industry previous) {
		...
		if (previous instanceof SGB_TheLastWorkStation) {
			SGB_TheLastWorkStation prev = (SGB_TheLastWorkStation) previous;
...
//		}
	...
	public String getUnavailableReason() {
		return "It Could not been Build";
	}
