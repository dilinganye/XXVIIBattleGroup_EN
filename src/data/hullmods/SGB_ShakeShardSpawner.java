...
public class SGB_ShakeShardSpawner extends BaseHullMod {

	public static Color JITTER_COLOR = new Color(245, 219, 206, 50);
	...
	static {
		...
		fighters.get(ShardType.GENERAL).add("SGB_Carbonization_Attack_wing", 10f);
		fighters.get(ShardType.MISSILE).add("SGB_Carbonization_Missile_wing", 15f);
		fighters.get(ShardType.POINT_DEFENSE).add("SGB_Carbonization_Support_wing", 10f);
		fighters.get(ShardType.ANTI_SHIELD).add("SGB_Carbonization_AntiShield_wing", 10f);

		//Copier
		fighters.get(ShardType.GENERAL).add("SGB_Overcurrent_Attack", 2f);
		fighters.get(ShardType.MISSILE).add("SGB_Overcurrent_Missile", 2f);
		fighters.get(ShardType.POINT_DEFENSE).add("SGB_Overcurrent_Support", 2f);
		fighters.get(ShardType.ANTI_SHIELD).add("SGB_Overcurrent_AntiShield", 2f);
		
		ShardTypeVariants small = new ShardTypeVariants();
		variantData.put(HullSize.FRIGATE, small);
		//欠压 - 抗伤
		small.get(ShardType.GENERAL).add("SGB_Undervoltage_Attack", 5f);
		small.get(ShardType.GENERAL).add("SGB_Undervoltage_Support", 5f);

		small.get(ShardType.POINT_DEFENSE).add("SGB_Undervoltage_Support", 10f);
		small.get(ShardType.MISSILE).add("SGB_Undervoltage_Missile", 10f);
		small.get(ShardType.ANTI_ARMOR).add("SGB_Undervoltage_AntiArmor", 10f);
		small.get(ShardType.ANTI_SHIELD).add("SGB_Undervoltage_AntiShield", 10f);
		//错移 - 突刺
		small.get(ShardType.GENERAL).add("SGB_Misalignment_Attack", 7f);
		small.get(ShardType.GENERAL).add("SGB_Misalignment_Support", 3f);

		small.get(ShardType.POINT_DEFENSE).add("SGB_Misalignment_Support", 10f);
		small.get(ShardType.MISSILE).add("SGB_Misalignment_Missile", 10f);
		small.get(ShardType.ANTI_SHIELD).add("SGB_Misalignment_AntiShield", 10f);

		//Copier
		small.get(ShardType.GENERAL).add("SGB_Overcurrent_Attack", 5f);
		small.get(ShardType.MISSILE).add("SGB_Overcurrent_Missile", 5f);
		small.get(ShardType.POINT_DEFENSE).add("SGB_Overcurrent_Support", 5f);
		small.get(ShardType.ANTI_SHIELD).add("SGB_Overcurrent_AntiShield", 5f);
		//wings
		small.get(ShardType.GENERAL).add("SGB_Carbonization_Attack_wing", 1f);
		small.get(ShardType.MISSILE).add("SGB_Carbonization_Missile_wing", 1f);
		small.get(ShardType.POINT_DEFENSE).add("SGB_Carbonization_Support_wing", 1f);
		small.get(ShardType.ANTI_SHIELD).add("SGB_Carbonization_AntiShield_wing", 1f);

		ShardTypeVariants medium = new ShardTypeVariants();
		variantData.put(HullSize.DESTROYER, medium);

		medium.get(ShardType.ANTI_SHIELD).add("SGB_LargeGrain_AntiShield", 10f);
		medium.get(ShardType.GENERAL).add("SGB_LargeGrain_Attack", 10f);
		medium.get(ShardType.MISSILE).add("SGB_LargeGrain_Missile", 10f);
		medium.get(ShardType.POINT_DEFENSE).add("SGB_LargeGrain_Support", 10f);
		medium.get(ShardType.ANTI_ARMOR).add("SGB_LargeGrain_AntiArmor", 10f);
